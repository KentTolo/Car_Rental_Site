...
if(isset($_POST['signup']))
{
    ...
    if ($password !== $confirmpassword) {
      ...
      exit;
        ...
        // Passwords match, proceed with the registration process
        $hashedPassword = md5($password);

        // Your database insertion logic
        $sql="INSERT INTO  tblusers(FullName,EmailId,ContactNo,Password,Age) VALUES(:fname,:email,:mobile,:password,:age)";
        $query = $dbh->prepare($sql);
        $query->bindParam(':fname', $fname, PDO::PARAM_STR);
...
function valid()
{
  console.log(createString("Password and Confirm Password Field do not match  !!"));
          ...
          <div class="signup_wrap">
            <div class="col-md-12 col-sm-6">
              <form  method="post" name="signup" onSubmit="return valid();">
                ...
                <div class="form-group">
                  <input type="int" class="form-control" name="age" placeholder="age" required="required">
                </div>
                <div class="form-group">
